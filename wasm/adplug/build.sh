...
emcc -O3 \
    ...
    -s EXPORTED_FUNCTIONS="['_malloc','_free','_emu_init','_emu_teardown','_emu_add_file','_emu_load_file','_emu_compute_audio_samples','_emu_get_audio_buffer','_emu_get_audio_buffer_length','_emu_get_current_position','_emu_get_max_position','_emu_seek_position','_emu_get_track_info','_emu_get_subsong_count','_emu_set_subsong','_emu_get_sample_rate','_emu_rewind','_emu_get_current_tick']" \
